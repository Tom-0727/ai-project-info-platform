...
That prints the current branch, local revision, remote `origin/main` revision, working tree status, systemd service state, live `/api/health` payload, and whether local/live/remote revisions are aligned.
